...
@section('content')
 <div class="panel panel-default">
                <div class="panel-heading">Confirm delete this record on Categories</div>
                    <div class="panel-body">{!! Form::model($rows,array('route' => 'categories/destroy', 'class' => 'form-horizontal')) !!}
<!------------------------------------------------------------->
...
{!! Form::button('Cancel', array('class'=>'btn btn-warning pull-left','id'=>'closeMe')) !!}{!! Form::submit('Submit', array('class'=>'btn btn-danger pull-right','id'=>'deleteMe')) !!}</div>
</div>
